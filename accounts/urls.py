...
from .views import register, profile, delete_weight_entry, delete_ftp_entry, toggle_ftp_active, delete_pace_entry, toggle_pace_active, create_pace_level, delete_pace_level, CustomLoginView
