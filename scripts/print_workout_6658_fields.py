...
def print_workout_fields(workout_id):
    ...
    print(f"device_type_display_name: {getattr(workout, 'device_type_display_name', None)}")
    ...
    if workout.ride_detail:
        ...
        print(f"ride_detail.workout_type: {getattr(workout.ride_detail.workout_type, 'slug', None)}")
    else:
